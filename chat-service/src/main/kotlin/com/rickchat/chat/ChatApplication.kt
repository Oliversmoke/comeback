package com.rickchat.chat

import com.rickchat.chat.routes.ChatRoutes
import com.rickchat.chat.websocket.ChatWebSocketHandler
...
fun main() {
    ...
    embeddedServer(Netty, port = 8083, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing {
        ChatRoutes().register(this)
        ChatWebSocketHandler().register(this)
    }
}
