              ...
              >
                ...
                {tab === 'users' ? (
                  <>
                    ...
                    <div className="text-right">
                      <p className="text-lg font-bold text-accent-400">{(entry as LeaderboardEntry).xp.toLocaleString()}</p>
                  ...
                  <>
                    ...
                    <div className="text-right">
                      <p className="text-lg font-bold text-accent-400">{(entry as GroupLeaderboardEntry).totalXp.toLocaleString()}</p>
              ...
              >
                ...
                {tab === 'users' ? (
                  <>
                    ...
                    <span className="text-accent-400 font-semibold">{(entry as LeaderboardEntry).xp.toLocaleString()}</span>
                  </>
                ) : (
                  <>
                    ...
                    <span className="text-accent-400 font-semibold">{(entry as GroupLeaderboardEntry).totalXp.toLocaleString()}</span>
                  </>
                )}
              </motion.div>
            </StaggerItem>
