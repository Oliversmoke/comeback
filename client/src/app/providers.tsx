...
import { NexusBackground } from '@/components/nexus/NexusPrimitives';
...
export function Providers({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen">
      <Navbar />
      <div className="relative flex lg:pt-0 pt-14 pb-16 lg:pb-0">
        <Sidebar />
        <main className="relative flex-1 min-h-screen p-4 lg:p-8 max-w-7xl mx-auto w-full">
          <NexusBackground />
          <AnimatePresence mode="wait">
            <motion.div
              key={pathname}
