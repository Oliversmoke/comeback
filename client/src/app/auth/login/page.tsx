...
import { Target, Eye, EyeOff, ArrowRight, Wallet } from 'lucide-react';
import { z } from 'zod';
...
export default function LoginPage() {
  ...
  const handleWalletLogin = async () => {
    ...
    const { ok } = await loginWithWallet({ successMessage: 'Wallet connected!' });
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs text-dark-400">or sign in with email</span>
            <div className="flex-1 h-px bg-dark-700" />
          </div>
