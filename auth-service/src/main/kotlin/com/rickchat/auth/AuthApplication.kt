package com.rickchat.auth

import com.rickchat.auth.routes.AuthRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8081, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing {
        AuthRoutes(jwtService, appConfig).register(this)
    }
}
