package com.rickchat.accessibility

import com.rickchat.accessibility.routes.AccessibilityRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8089, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { AccessibilityRoutes().register(this) }
}
