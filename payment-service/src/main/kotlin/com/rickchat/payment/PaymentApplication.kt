...
import com.rickchat.payment.routes.PaymentRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8093, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { PaymentRoutes().register(this) }
}
