...
import com.rickchat.admin.routes.AdminRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8097, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { AdminRoutes().register(this) }
}
