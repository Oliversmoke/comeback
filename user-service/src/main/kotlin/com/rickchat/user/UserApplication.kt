...
import com.rickchat.user.routes.UserRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8082, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { UserRoutes().register(this) }
}
