...
import com.rickchat.learning.routes.LearningRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8087, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { LearningRoutes().register(this) }
}
