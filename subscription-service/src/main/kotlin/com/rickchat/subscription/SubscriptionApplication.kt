package com.rickchat.subscription
...
import com.rickchat.subscription.routes.SubscriptionRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8094, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { SubscriptionRoutes().register(this) }
}
