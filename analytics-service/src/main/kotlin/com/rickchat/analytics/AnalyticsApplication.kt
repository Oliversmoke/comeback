package com.rickchat.analytics
...
import com.rickchat.analytics.routes.AnalyticsRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8096, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { AnalyticsRoutes().register(this) }
}
