package com.rickchat.notification
...
import com.rickchat.notification.routes.NotificationRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8092, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { NotificationRoutes().register(this) }
}
