...
import com.rickchat.memory.routes.MemoryRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8085, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { MemoryRoutes(appConfig).register(this) }
}
