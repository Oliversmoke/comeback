package com.rickchat.aigateway

import com.rickchat.aigateway.routes.AIGatewayRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8084, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { AIGatewayRoutes(appConfig).register(this) }
}
