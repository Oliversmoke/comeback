...
import com.rickchat.voice.routes.VoiceRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8091, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { VoiceRoutes().register(this) }
}
