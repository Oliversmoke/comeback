package com.rickchat.translation
...
import com.rickchat.translation.routes.TranslationRoutes
...
fun main() {
    ...
    embeddedServer(Netty, port = 8088, host = appConfig.app.host) {
        module(appConfig)
    }.start(wait = true)
}
...
fun Application.module(appConfig: AppConfig) {
    ...
    routing { TranslationRoutes().register(this) }
}
